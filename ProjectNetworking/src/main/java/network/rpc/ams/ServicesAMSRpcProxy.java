...
public class ServicesAMSRpcProxy implements IServicesAMS {
    private String host;
    private int port;
    ...
    public ServicesAMSRpcProxy(String host, int port) {
        this.host = host;
        this.port = port;
    ...
    @Override
    public void login(Admin admin) throws ProjectException {
    ...
    @Override
    public void logout(Admin admin) throws ProjectException {
